package group.phorus.service.commons.dtos.validationGroups
 ...
 *
 * [CrudController][group.phorus.service.commons.controller.CrudController] automatically applies
 * `@Validated(Create::class)` to the `POST` endpoint's request body.
 *
 * Behind the scenes, [CrudService][group.phorus.service.commons.service.CrudService] uses
