...
import group.phorus.service.commons.service.fetchAndMapTo
import group.phorus.service.commons.service.transactionalMapTo
...
class TransactionStepsDefinition(
    ...
    fun `the User detail response has N addresses`(expected: Int) {
        val response = responseScenarioScope.responseSpec!!
            .expectBody<UserDetailResponse>().returnResult().responseBody!!
